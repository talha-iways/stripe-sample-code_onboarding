        ...
        {!accountCreatePending && !connectedAccountId && (
          <button
            onClick={async () => {
              ...
              // account
              fetch("https://ayatunes-payment-dev.internal.pwr.dev/account/create", {
                method: "POST",
              })
        ...
        {connectedAccountId && !accountLinkCreatePending && (
          <button
            onClick={async () => {
              ...
              // account link
              fetch(`https://ayatunes-payment-dev.internal.pwr.dev/account/link?accountId=${connectedAccountId}`, {
                method: "POST",
                headers: {
